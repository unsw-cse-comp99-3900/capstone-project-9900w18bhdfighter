...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="CourseCode",
            fields=[
                ("CourseCodeID", models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name="TimeRule",
            fields=[
                ("TimeNodeID", models.AutoField(primary_key=True, serialize=False)),
                (
                    "GroupFreezeTime",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        through="myapp.GroupProjectsLink", to="myapp.group"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="myapp.GroupPreference", to="myapp.project"
            ),
        ),
        migrations.CreateModel(
            name="Skill",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "Areas",
                    models.ManyToManyField(
                        through="myapp.StudentArea", to="myapp.area"
                    ),
                ),
                (
                    "Contacts",
                    models.ManyToManyField(through="myapp.Contact", to="myapp.user"),
                ),
                (
                    "CourseCode",
                    models.ForeignKey(
                ...
                (
                    "Notifications",
                    models.ManyToManyField(
                        through="myapp.NotificationReceiver", to="myapp.notification"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name="ReadBy",
            field=models.ManyToManyField(
                related_name="read_notifications", to="myapp.user"
            ),
        ),
        migrations.AddField(
            model_name="notification",
            ...
            field=models.ManyToManyField(
                ...
                through="myapp.NotificationReceiver",
                to="myapp.user",
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ReadBy",
                    models.ManyToManyField(
                        related_name="read_group_messages", to="myapp.user"
                    ),
                ),
                (
                    "Sender",
        ...
        migrations.AddField(
            ...
            name="GroupMembers",
            field=models.ManyToManyField(
                through="myapp.GroupUsersLink", to="myapp.user"
            ),
        ),
        migrations.AddField(
            model_name="contact",
